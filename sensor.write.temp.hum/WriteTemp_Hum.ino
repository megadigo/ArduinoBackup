...
//#define USE_WIFI_SHIELD
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "DIG";          //  your network SSID (name) 
    char pass[] = "cf48df7d74e1";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 125526;
const char * myWriteAPIKey = "RI9Q7ZJYETJXIFI7";
